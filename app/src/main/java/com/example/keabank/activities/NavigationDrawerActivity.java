...
/* navigation activity - Instantiate fragments */
public class NavigationDrawerActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
	...
	/* if drawer (navigation) is open, back button will close it. Otherwise it will perform basic back operation to previous activity
